					...
					<div class="card-body">
						...
						<form action="{{ url('admin/medicines_stock/edit/'.$oldRecord->id) }}" method="post" enctype="multipart/form-data">
			                ...
			                <div class="form-group row mb-4">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="text" name="batch_id" class="form-control" placeholder="Enter Batch Id" value="{{ $oldRecord->batch_id }}">
			                ...
			                <div class="form-group row mb-4">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="date" name="expire_date" class="form-control" placeholder="Enter Expire Date" value="{{ $oldRecord->expire_date }}">
			                ...
			                <div class="form-group row mb-4">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="text" name="quantity" class="form-control" placeholder="Enter Quantity" value="{{ $oldRecord->quantity }}">
			                ...
			                <div class="form-group row mb-4">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="text" name="mrp" class="form-control" placeholder="Enter MRP" value="{{ $oldRecord->mrp }}">
			                ...
			                <div class="form-group row mb-4">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="text" name="rate" class="form-control" placeholder="Enter Rate" value="{{ $oldRecord->rate }}">
