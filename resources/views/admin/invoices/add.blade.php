	...
	<section class="section">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">Invoice Add</h5>
						...
						<form action="{{ url('admin/invoices/add') }}" method="post" enctype="multipart/form-data">
							...
							<div class="form-group row mb-4">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="text" name="net_total" class="form-control" placeholder="Enter Net Total" value="">
			                ...
			                <div class="form-group row mb-4">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="date" name="invoices_date" class="form-control" placeholder="Enter Invoice Date" value="">
			                ...
			                <div class="form-group row mb-4">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="text" name="total_discount" class="form-control" placeholder="Enter Total Discunt" value="">
