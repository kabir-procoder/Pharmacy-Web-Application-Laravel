			...
			<div class="col-md-12">
				...
				<div class="card">
					<div class="card-body">
						...
						<form action="{{ url('admin/supplires/edit/'.$getRecord->id) }}" method="post" enctype="multipart/form-data">
			                ...
			                <div class="form-group row mb-4">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="text" name="supplires_name" class="form-control" placeholder="Enter Supplires Name" value="{{ $getRecord->supplires_name }}">
			                ...
			                <div class="form-group row mb-4">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="email" name="supplires_email" class="form-control" placeholder="Enter Supplires Email" value="{{ $getRecord->supplires_email }}">
			                ...
			                <div class="form-group row mb-4">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="number" name="supplires_number" class="form-control" placeholder="Enter Supplires Number" value="{{ $getRecord->supplires_number }}">
			                ...
			                <div class="form-group row mb-4">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="text" name="address" class="form-control" placeholder="Enter Address" value="{{ $getRecord->address }}">
